...
func Get(url string) (*client.Request, *http.Response, error) {
	return DefaultClient.Get(url)
}

// Post makes a POST request to a given URL
func Post(url string, mimetype string, r io.Reader) (*client.Request, *http.Response, error) {
	return DefaultClient.Post(url, mimetype, r)
}

// Do sends a http request and returns a response
func Do(req *http.Request) (*client.Request, *http.Response, error) {
	return DefaultClient.Do(req)
}

// Dor sends a retryablehttp request and returns a response
func Dor(req *retryablehttp.Request) (*client.Request, *http.Response, error) {
	return DefaultClient.Dor(req)
}

// DoRaw does a raw request with some configuration
func DoRaw(method, url, uripath string, headers map[string][]string, body io.Reader) (*client.Request, *http.Response, error) {
	return DefaultClient.DoRaw(method, url, uripath, headers, body)
}

// DoRawWithOptions does a raw request with some configuration
func DoRawWithOptions(method, url, uripath string, headers map[string][]string, body io.Reader, options *Options) (*client.Request, *http.Response, error) {
